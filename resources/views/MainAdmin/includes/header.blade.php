            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    ...
                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        <!--begin::Menu wrapper-->
                        <div class="cursor-pointer symbol symbol-50px symbol-md-50px" data-kt-menu-trigger="click"
                            ...
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <img alt="Logo" src="{{asset('')}}/default.jpg"/>
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Username-->
                                    <div class="d-flex flex-column">
                                        <div class="fw-bolder d-flex align-items-center fs-5">{{env('LOGIN_ADMIN')}}
                                            <span
                                                class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2"></span>
                                        </div>
                                        <a href="javascript:void($this);"
                                           class="fw-bold text-muted text-hover-primary fs-7">{{env('LOGIN_ADMIN')}}</a>
                                    </div>
                                    <!--end::Username-->
                                </div>
                            </div>
...
{{--                                <a href="{{route('admin.supervisors.edit', auth()->user()->id)}}" class="menu-link px-5">ملف--}}
{{--                                    شخصي</a>--}}
{{--                            </div>--}}
                            <!--end::Menu item-->
