...
<head>
    <!--head area start-->
    @include('MainAdmin.includes.head')
    <!--head area end-->
...
<div class="d-flex flex-column flex-root">
    ...
    @include('MainAdmin.includes.sidemenu')

    <!--begin::Wrapper-->
    <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">

        @include('MainAdmin.includes.header')

        @yield('content')

        @include('MainAdmin.includes.footer')
...
{{--                            <a href="http://tesolutionspro.com">Keenthemes.com</a></div>--}}
{{--                        <!--end::Text-->--}}
{{--                    </div>--}}
{{--                    <!--end::Wrapper-->--}}
{{--                </div>--}}
...
@include('MainAdmin.includes.js')

<!--foot area start-->
@include('MainAdmin.includes.foot')
<!--foot area end-->
